...
import { stageWindowsGnuPrebuilts } from "./package-release.ts";
...
if (action === "update" && Deno.build.os === "windows") {
  await stageWindowsGnuPrebuilts(root);
  console.log("Staged verified Windows GNU SDL prebuilts for Zig examples.");
}
