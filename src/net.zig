...
comptime {
    if (@sizeOf(Status) != @sizeOf(c.NET_Status)) @compileError("ABI size mismatch for Status");
    if (@alignOf(Status) != @alignOf(c.NET_Status)) @compileError("ABI alignment mismatch for Status");
}
...
comptime {
    if (@sizeOf(Datagram) != @sizeOf(c.NET_Datagram)) @compileError("ABI size mismatch for Datagram");
    if (@alignOf(Datagram) != @alignOf(c.NET_Datagram)) @compileError("ABI alignment mismatch for Datagram");
    if (@offsetOf(Datagram, "addr") != @offsetOf(c.NET_Datagram, "addr")) @compileError("ABI field mismatch for Datagram.addr");
    if (@offsetOf(Datagram, "port") != @offsetOf(c.NET_Datagram, "port")) @compileError("ABI field mismatch for Datagram.port");
    if (@offsetOf(Datagram, "buf") != @offsetOf(c.NET_Datagram, "buf")) @compileError("ABI field mismatch for Datagram.buf");
    if (@offsetOf(Datagram, "buflen") != @offsetOf(c.NET_Datagram, "buflen")) @compileError("ABI field mismatch for Datagram.buflen");
}
