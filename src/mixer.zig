...
comptime {
    if (@sizeOf(Point3d) != @sizeOf(c.MIX_Point3D)) @compileError("ABI size mismatch for Point3d");
    if (@alignOf(Point3d) != @alignOf(c.MIX_Point3D)) @compileError("ABI alignment mismatch for Point3d");
    if (@offsetOf(Point3d, "x") != @offsetOf(c.MIX_Point3D, "x")) @compileError("ABI field mismatch for Point3d.x");
    if (@offsetOf(Point3d, "y") != @offsetOf(c.MIX_Point3D, "y")) @compileError("ABI field mismatch for Point3d.y");
    if (@offsetOf(Point3d, "z") != @offsetOf(c.MIX_Point3D, "z")) @compileError("ABI field mismatch for Point3d.z");
}
...
comptime {
    if (@sizeOf(StereoGains) != @sizeOf(c.MIX_StereoGains)) @compileError("ABI size mismatch for StereoGains");
    if (@alignOf(StereoGains) != @alignOf(c.MIX_StereoGains)) @compileError("ABI alignment mismatch for StereoGains");
    if (@offsetOf(StereoGains, "left") != @offsetOf(c.MIX_StereoGains, "left")) @compileError("ABI field mismatch for StereoGains.left");
    if (@offsetOf(StereoGains, "right") != @offsetOf(c.MIX_StereoGains, "right")) @compileError("ABI field mismatch for StereoGains.right");
}
...
comptime {
    if (builtin.abi == .android or builtin.abi == .androideabi) {
        ...
        _ = root.AudioDecoder;
        _ = root.Group;
        _ = root.GroupMixCallback;
        _ = root.Mixer;
        _ = root.Point3d;
        _ = root.PostMixCallback;
        _ = root.StereoGains;
        _ = root.Track;
        _ = root.TrackMixCallback;
        _ = root.TrackStoppedCallback;
        _ = root.audioFramesToMs;
        _ = root.audioMsToFrames;
        _ = root.createAudioDecoder;
        _ = root.createAudioDecoderIo;
        _ = root.createGroup;
        _ = root.createMixer;
        _ = root.createMixerDevice;
        _ = root.createSineWaveAudio;
        _ = root.createTrack;
        _ = root.decodeAudio;
        _ = root.duration_infinite;
        _ = root.duration_unknown;
        _ = root.framesToMs;
        _ = root.generate;
        _ = root.getAudioDecoder;
        _ = root.getAudioDecoderFormat;
        _ = root.getAudioDecoderProperties;
        _ = root.getAudioDuration;
        _ = root.getAudioFormat;
        _ = root.getAudioProperties;
        _ = root.getGroupMixer;
        _ = root.getGroupProperties;
        _ = root.getMixerFormat;
        _ = root.getMixerFrequencyRatio;
        _ = root.getMixerGain;
        _ = root.getMixerProperties;
        _ = root.getNumAudioDecoders;
        _ = root.getTaggedTracks;
        _ = root.getTrack3dPosition;
        _ = root.getTrackAudio;
        _ = root.getTrackAudioStream;
        _ = root.getTrackFadeFrames;
        _ = root.getTrackFrequencyRatio;
        _ = root.getTrackGain;
        _ = root.getTrackLoops;
        _ = root.getTrackMixer;
        _ = root.getTrackPlaybackPosition;
        _ = root.getTrackProperties;
        _ = root.getTrackRemaining;
        _ = root.getTrackTags;
        _ = root.init;
        _ = root.loadAudio;
        _ = root.loadAudioIo;
        _ = root.loadAudioNoCopy;
        _ = root.loadAudioWithProperties;
        _ = root.loadRawAudio;
        _ = root.loadRawAudioIo;
        _ = root.loadRawAudioNoCopy;
        _ = root.lockMixer;
        _ = root.msToFrames;
        _ = root.pauseAllTracks;
        _ = root.pauseTag;
        _ = root.pauseTrack;
        _ = root.playAudio;
        _ = root.playTag;
        _ = root.playTrack;
        _ = root.prop_audio_decoder_string;
        _ = root.prop_audio_load_closeio_boolean;
        _ = root.prop_audio_load_ignore_loops_boolean;
        _ = root.prop_audio_load_io_stream_pointer;
        _ = root.prop_audio_load_predecode_boolean;
        _ = root.prop_audio_load_preferred_mixer_pointer;
        _ = root.prop_audio_load_skip_metadata_tags_boolean;
        _ = root.prop_metadata_album_string;
        _ = root.prop_metadata_artist_string;
        _ = root.prop_metadata_copy_right_string;
        _ = root.prop_metadata_duration_frames_number;
        _ = root.prop_metadata_duration_infinite_boolean;
        _ = root.prop_metadata_title_string;
        _ = root.prop_metadata_total_tracks_number;
        _ = root.prop_metadata_track_number;
        _ = root.prop_metadata_year_number;
        _ = root.prop_mixer_device_number;
        _ = root.prop_play_app_end_silence_frames_number;
        _ = root.prop_play_app_end_silence_milliseconds_number;
        _ = root.prop_play_fade_in_frames_number;
        _ = root.prop_play_fade_in_milliseconds_number;
        _ = root.prop_play_fade_in_start_gain_float;
        _ = root.prop_play_halt_when_exhausted_boolean;
        _ = root.prop_play_loop_start_frame_number;
        _ = root.prop_play_loop_start_millisecond_number;
        _ = root.prop_play_loops_number;
        _ = root.prop_play_max_frame_number;
        _ = root.prop_play_max_milliseconds_number;
        _ = root.prop_play_start_frame_number;
        _ = root.prop_play_start_millisecond_number;
        _ = root.prop_play_start_order_number;
        _ = root.quit;
        _ = root.resumeAllTracks;
        _ = root.resumeTag;
        _ = root.resumeTrack;
        _ = root.setGroupPostMixCallback;
        _ = root.setMixerFrequencyRatio;
        _ = root.setMixerGain;
        _ = root.setPostMixCallback;
        _ = root.setTagGain;
        _ = root.setTrack3dPosition;
        _ = root.setTrackAudio;
        _ = root.setTrackAudioStream;
        _ = root.setTrackCookedCallback;
        _ = root.setTrackFrequencyRatio;
        _ = root.setTrackGain;
        _ = root.setTrackGroup;
        _ = root.setTrackIoStream;
        _ = root.setTrackLoops;
        _ = root.setTrackOutputChannelMap;
        _ = root.setTrackPlaybackPosition;
        _ = root.setTrackRawCallback;
        _ = root.setTrackRawIoStream;
        _ = root.setTrackStereo;
        _ = root.setTrackStoppedCallback;
        _ = root.stopAllTracks;
        _ = root.stopTag;
        _ = root.stopTrack;
        _ = root.tagTrack;
        _ = root.trackFramesToMs;
        _ = root.trackMsToFrames;
        _ = root.trackPaused;
        _ = root.trackPlaying;
        _ = root.unlockMixer;
        _ = root.untagTrack;
